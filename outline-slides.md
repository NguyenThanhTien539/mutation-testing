...
*   **Đối tượng:** Kỹ sư phần mềm, QA/QC.
...
| **JaCoCo/nyc** | Java/JS | *Chỉ Coverage* | Rất tốt | Rất cao | EPL/ISC |

*   *Ghi chú:* JaCoCo và Istanbul (nyc) không phải mutation tool nhưng thường dùng làm baseline.
