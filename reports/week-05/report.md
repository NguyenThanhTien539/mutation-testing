...
#### Task 1: Tải về, tìm hiểu và setup công cụ Mutmut

- Mục tiêu: tổng hợp lại các thông tin cơ bản về Mutmut, tìm repository tương ứng và tìm cách để sử dụng công cụ thành công
- Minh chứng: .md
- Sử dụng AI: sử dụng AI để làm rõ và chỉnh sửa các lỗi nhất thống phiên bản do Mutmut đã được thay đổi nhiều so với phiên bản cũ

#### Task 2: Lập hướng dẫn cài Mutmut và setup 1 demo mẫu

- Mục tiêu: ghi lại các bước cài đặt dependency, sử dụng công cụ và cho 1 ví dụ mẫu để thành viên khác có thể tự sử dụng Mutmut 1 cách nhanh chóng
- Minh chứng: .md
- Sử dụng AI: sử dụng AI để chuẩn hóa và tổng hợp lại nội dung repository ra 1 file nội dung để tóm tắt ngắn gọn.
